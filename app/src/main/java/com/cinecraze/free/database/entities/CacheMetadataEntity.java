...
public class CacheMetadataEntity {
    ...
    @ColumnInfo(name = "playlist_urls")
    private String playlistUrls; // JSON string of playlist URLs
    ...
    public String getPlaylistUrls() { return playlistUrls; }
    public void setPlaylistUrls(String playlistUrls) { this.playlistUrls = playlistUrls; }
}